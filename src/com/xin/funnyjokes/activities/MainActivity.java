...
public class MainActivity extends ActionBarActivity {
	...
	private void selectItem(int position) {
		...
		if (fragment == null) {
			fragment = new JokeCategoryFragment();
			Bundle args = new Bundle();
			String category = getResources().getStringArray(R.array.joke_categories_array)[position];
			args.putString(JokeCategoryFragment.ARG_JOKE_CATEGORY, category);
		...
		ft.replace(R.id.content_frame, fragment); // f1_container is your FrameLayout container
